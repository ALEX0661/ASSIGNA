...
if (!document.getElementById('rooms-page-style')) {
  ...
  s.textContent = `
    ...
    .room-chip.drag-over { border-color: var(--meadow-text); background: ${G.meadowBorder}; transform: scale(1.02); }
    ...
    .inline-add-input:focus { border-color: var(--meadow-text-hover); border-style: solid; box-shadow: 0 0 0 2px rgba(0,0,0,0.1); background: var(--surface); }
