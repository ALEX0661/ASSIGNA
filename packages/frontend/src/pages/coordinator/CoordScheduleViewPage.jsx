    ...
    <div className="page" style={{ padding:'15px 15px 30px', overflowX:'hidden', width:'100%', minWidth:0 }}>
      ...
      <div className="sv-header-row">
          ...
          {isEditingName ? (
            ...
            <div style={{ minWidth:0, flexShrink:0, display:'flex', alignItems:'center', gap:5 }}>
              <div>
                ...
                {(schedAY || schedSem) && (
                  <div style={{ fontSize:10.5, marginTop:1, color:'var(--muted2)', fontWeight:500, whiteSpace:'nowrap' }}>
              ...
              {activeName && !isMasterView && (
                <button
                  ...
                  style={{ background:'transparent', border:'none', cursor:'pointer', color:'var(--muted2)', display:'flex', alignItems:'center', padding:4, borderRadius:6, flexShrink:0 }}
                  title="Rename"
                >
        ...
        <div id="tour-sv-save" className="sv-header-cluster">
          ...
          {allEvents.length > 0 && (
            <ExportMenuButton onExportSchedule={handleExport} onExportRooms={handleExportAvailableRooms} onExportSchedulePdf={handleExportSchedulePdf} />
          )}
        </div>
      </div>
